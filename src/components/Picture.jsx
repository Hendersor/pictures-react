...
const Picture = () => {
  return (
    <figure className="pictureContainer">
      <img
        src="https://www.infobae.com/new-resizer/Xke0dHEgowRw8K83VUONthii-Bo=/768x768/filters:format(webp):quality(85)/arc-anglerfish-arc2-prod-infobae.s3.amazonaws.com/public/5CKDOKIYKNHLXKKFIABW3WRASY.jpg"
        alt="picture"
